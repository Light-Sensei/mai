        ...
        if should_welc:
            ...
            if new_mem.id == OWNER_ID:
                ...
                welcome_log = (
                    ...
                    f"#USER_JOINED\n"
                    f"My Hubby just joined the chat"
                )
                continue
            ...
            if new_mem.id in DRAGONS:
                update.effective_message.reply_text(
                    "Huh! My Kyōdai just joined! Stay Alert!",
                    reply_to_message_id=reply,
                )
                continue
            ...
            if new_mem.id in WOLVES:
                update.effective_message.reply_text(
                    "Oof! My Tomodachi just joined!", reply_to_message_id=reply
                )
                continue
